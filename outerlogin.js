...
bKB='<div id="divLoginpanelHor" class="bizmail_loginpanel" style="width:550px;"><div class="bizmail_LoginBox"><h3>µÇÂ¼ÓÊÏä</h3><form name="form1" action="https://exmail.qq.com/cgi-bin/login" method="post" onsubmit="'+bhu+'"><input type="hidden" name="firstlogin" value="false" /><input type="hidden" name="errtemplate" value="dm_loginpage" /><input type="hidden" name="aliastype" value="other" /><input type="hidden" name="dmtype" value="bizmail" /><input type="hidden" name="p" value="" /><label>ÕÊºÅ:</label><input type="text" name="uin" class="text" value="" />@#domainlist#<label>&nbsp;ÃÜÂë:</label><input type="password" name="pwd" class="text" value="" /><input type="submit" class="" name="" value="µÇÂ¼" />&nbsp;<a href="https://exmail.qq.com/cgi-bin/readtemplate?check=false&t=bizmail_orz" target="_blank">Íü¼ÇÃÜÂë£¿</a></form></div></div>',
bKw='<div id="divLoginpanelVer" class="bizmail_loginpanel"><div class="bizmail_LoginBox"><h3>µÇÂ¼ÓÊÏä</h3><form name="form1" action="https://exmail.qq.com/cgi-bin/login" method="post" onsubmit="'+bhu+'"><input type="hidden" name="firstlogin" value="false" /><input type="hidden" name="errtemplate" value="dm_loginpage" /><input type="hidden" name="aliastype" value="other" /><input type="hidden" name="dmtype" value="bizmail" /><input type="hidden" name="p" value="" /><div class="bizmail_column"><label>ÕÊºÅ:</label><div class="bizmail_inputArea"><input type="text" tabindex="1" name="uin" class="text" value="" />@#domainlist#</div></div><div class="bizmail_column"><label>ÃÜÂë:</label><div class="bizmail_inputArea"><input type="password" tabindex="2" name="pwd" class="text" value="" />&nbsp;&nbsp;<a href="https://exmail.qq.com/cgi-bin/readtemplate?check=false&t=bizmail_orz" target="_blank">Íü¼ÇÃÜÂë£¿</a></div></div><div class="bizmail_SubmitArea"><table height="38" valign="top"><tr><td height="38"></td><td height="38" valign="bottom"><button id="loginBtn" class="btn btn-login formSubmit" tabindex="6" type="submit"><img name="login" id="login" src="images/login.gif" width="110" height="38" border="0" alt=""></button></td><td height="38" valign="top">&nbsp;<a id="lfBtnReg" class="btn btn-reg" href="./reg/" tabindex="7"><img name="reg" src="images/reg.gif" width="110" height="38" border="0" alt=""></a></td><td height="38"></td></tr></table></div></form><br><h3>&nbsp;</h3><div class="myself"><a href="http://exmail.qq.com" target="_blank">ÌÚÑ¶Ãâ·ÑÆóÒµÓÊ¾Ö</a><br><a href="http://exmail.qq.com" target="_blank">Ãâ·Ñ·¢3G´ó¸½¼şÓÊ¼ş</a><br><br></div></div></div>';
